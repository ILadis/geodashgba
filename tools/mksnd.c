...
static void song1(SoundPlayer *player, SoundSampler *sampler) {
  ...
  SoundTrack_AssignNotes(&track1, notes1, 3000);
  SoundTrack_AssignNotes(&track2, notes2, 3000);

  static SoundChannel channel1 = {0};
  static SoundChannel channel2 = {0};

  SoundChannel_SetTrackAndSampler(&channel1, &track1, sampler, 13); // 2^13 = 8192 sample rate
...
static void song2(SoundPlayer *player, SoundSampler *sampler) {

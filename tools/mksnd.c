...
static void song1(SoundPlayer *player) {
  ...
  SoundPlayer_AddChannel(player, NoteSoundChannel_Create(&channel1, notes1, 3000, 13)); // 2^13 = 8192 sample rate
  SoundPlayer_AddChannel(player, NoteSoundChannel_Create(&channel2, notes2, 3000, 13));
}
...
static void song2(SoundPlayer *player) {
  ...
  SoundPlayer_AddChannel(player, NoteSoundChannel_Create(&channel1, notes1, 2800, 13)); // 2^13 = 8192 sample rate
  SoundPlayer_AddChannel(player, NoteSoundChannel_Create(&channel2, notes2, 2800, 13));
}
